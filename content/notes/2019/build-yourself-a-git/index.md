...
Another expectation from a VCS that can fall through the cracks is <mark>security</mark>.
...
we introduce a <mark>layer of indirection</mark>, that will <mark>point memorable names to commits</mark>.
In Git terms, this layer of indirection is called <mark>refs</mark>.
...
While local branches are called <mark>heads</mark> internally, remote branches are called <mark>remotes</mark>.
...
Linus' [README from the first commit](https://github.com/git/git/blob/e83c5163316f89bfbde7d9ab23ca2e25604af290/README#L125)
